...
void TextureManager::Draw(const std::string& id, const glm::vec2 position, const GameObject* go, const double angle, const int alpha,
                          const bool centered, const SDL_RendererFlip flip)
{

...
void StartScene::Start()
{
	...
	m_pStartLabel = new Label("Cameron Bryson + Robert Oxley", "Consolas", 40, blue, glm::vec2(400.0f, 40.0f));
	m_pStartLabel->SetParent(this);
	AddChild(m_pStartLabel);

	m_pInstructionsLabel = new Label("101431086 + 101424472", "Consolas", 40, blue, glm::vec2(400.0f, 120.0f));
